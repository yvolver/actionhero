...
var actionProcessor = function(api, next){
  ...
  api.actionProcessor.prototype.completeAction = function(status, toRender, actionDomain){
    ...
    var traceWrapper = api.utils.createTracer( 'ah:actionProcessor:completeAction', function () {
  ...
  api.actionProcessor.prototype.preProcessAction = function(toProcess, callback){
    ...
    var traceWrapper = api.utils.createTracer( 'ah:actionProcessor:preProcessAction', function () {
      var priorities = [];
      var processors = [];
      ...
      priorities.forEach(function(priority){
        api.actions.preProcessors[priority].forEach(function(processor){
          processors.push(function(next){
            if(toProcess === true){
              processor(self.connection, self.actionTemplate, api.utils.createTracer( 'ah:actionProcessor:preprocessor:' + (processor.name || '<anon>'), function(connection, localToProcess){
      ...
      processors.push(api.utils.createTracer( 'ah:actionProcessor:preProcessAction:finish',function(){ callback(toProcess) }));
  ...
  api.actionProcessor.prototype.postProcessAction = function(toRender, callback){
    ...
    var traceWrapper = api.utils.createTracer( 'ah:actionProcessor:postProcessAction', function () {
      var priorities = [];
      var processors = [];
      ...
      priorities.forEach(function(priority){
        api.actions.postProcessors[priority].forEach(function(processor){
          processors.push(function(next){
            processor(self.connection, self.actionTemplate, toRender, api.utils.createTracer( 'ah:actionProcessor:postprocessor:' + (processor.name || '<anon>'), function(connection, localToRender){
              self.connection = connection;
  ...
  api.actionProcessor.prototype.duplicateCallbackHandler = function(actionDomain){
    var self = this;
    var traceWrapper = api.utils.createTracer( 'ah:actionProcessor:duplicateCallbackHandler', function () {
  ...
  api.actionProcessor.prototype.processAction = function(){
    ...
    var traceWrapper = api.utils.createTracer( 'ah:actionProcessor:processAction', function () {
  ...
  api.actionProcessor.prototype.runAction = function(actionDomain){
    var self = this;
    var traceWrapper = api.utils.createTracer( 'ah:actionProcessor:runAction', function () {
      var toProcess = true;
      var callbackCount = 0;
